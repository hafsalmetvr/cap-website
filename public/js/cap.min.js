...
} ]).directive("answerTypeSelect", [ "$http", function($http) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeText", [ "$http", function($http) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeCheckbox", [ "$http", function($http) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeRadio", [ "$http", function($http) {
    return {
        scope: {
            percentComplete: "="
        },
