                            ...
                            for (index = 0, length = optionGroup.length; index < length; index++) {
                                ...
                                if (existingOption = existingOptions[index + 1]) {
                                    ...
                                    if (option.id === "" && nullOption) {
                                        ...
                                        (element = optionTemplate.clone()).val(option.id).prop("selected", option.selected).text(option.label);
                                    }
...
angular.module("cap.controllers", []).controller("NavCtrl", [ "$scope", function($scope) {
...
angular.module("cap.directives", []).directive("capOverlay", [ "$rootScope", function($rootScope) {
    return {
        restrict: "A",
...
} ]).directive("capFooter", [ "footer", function(footer) {
    return {
        restrict: "C",
        replace: false,
        compile: function(element, attr, transclude) {
...
} ]).directive("answerTypeSelect", [ "$http", "overlay", function($http, overlay) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeTextarea", [ "$http", "overlay", function($http, overlay) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeText", [ "$http", "overlay", function($http, overlay) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeMultiselect", [ "$http", "answer", function($http, answer) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeCheckbox", [ "$http", "overlay", function($http, overlay) {
    return {
        restrict: "E",
        scope: {
            percentComplete: "="
...
} ]).directive("answerTypeRadio", [ "$http", "overlay", function($http, overlay) {
    return {
        scope: {
            percentComplete: "="
        },
...
} ]).directive("answerTypeEnum", [ "$http", "overlay", function($http, overlay) {
    return {
        scope: {
            startQuestionNumber: "=",
            endQuestionNumber: "=",
...
angular.module("cap.services", []).factory("customer", [ "$http", function($http) {
    ...
    return {
        ...
        message: function(message) {
            $rootScope.$broadcast("overlay-message", {
                message: message
            });
            return this;
        }
...
angular.module("cap.filters", []).filter("mysqlDate", [ function() {
