...
angular.module("cap.controllers.mentor", []).controller("DashboardCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", "customer", function($scope, $element, $http, $timeout, $window, $cookies, customer) {
    $scope.init = function() {
...
} ]).controller("QuestionnaireCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {} ]).controller("QuestionnairePageCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", function($scope, $element, $http, $timeout, $cookies, customer) {} ]).controller("MentorCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {} ]);