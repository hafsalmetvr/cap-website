...
var app = angular.module("cap", [ "ngRoute", "ngAnimate", "ngCookies", "cap.controllers", "cap.controllers.admin", "cap.filters", "cap.router", "cap.services", "cap.directives" ]);

app.config(function($interpolateProvider) {
    $interpolateProvider.startSymbol("[["), $interpolateProvider.endSymbol("]]");
}), app.config([ "$routeProvider", "$locationProvider", function() {} ]), angular.module("cap.controllers.admin", []).controller("DashboardCtrl", [ "$scope", "$element", "$http", "$timeout", "$location", "$cookies", "customer", function($scope, $element, $http, $timeout, $location, $cookies, customer) {
    console.log("dboardctrl"), $scope.init = function(user, role) {
