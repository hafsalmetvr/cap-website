...
angular.module("cap.controllers.admin", []).controller("QuestionnaireCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {} ]).controller("QuestionnairePageCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", "$window", function($scope, $element, $http, $timeout, $cookies, customer, overlay, $window) {
...
} ]).controller("MentorCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $cookies, customer, overlay) {
    $scope.modal = {};
...
} ]).controller("MenteeCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $cookies, customer, overlay) {
...
} ]).controller("AdminCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $cookies, customer, overlay) {} ]).controller("SettingsCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $cookies, customer, overlay) {
    $scope.init = function() {
...
} ]).controller("DashboardCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $cookies, customer, overlay) {
    ...
    $scope.assignFormToAccount = function(idx, accountIdx) {
        ...
        $http.put("/rest/questionnaire/" + form.id, {
            account: account.id
        }).success(function(data, status) {
...
} ]).controller('ManageQuestionnaireCtrl', ['$scope', '$element', '$http', '$timeout', '$window', '$cookies',
    function($scope, $element, $http, $timeout, $window, $cookies) {
        ...
        $scope.edit_questionnaire = function(){
            $scope.current_questionnaire = $scope.questionnaire;
        }
    }
]);
