...
angular.module("cap.controllers.admin", []).controller("QuestionnaireCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {} ]).controller("QuestionnairePageCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", function($scope, $element, $http, $timeout, $cookies, customer) {} ]).controller("MentorCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", function($scope, $element, $http, $timeout, $cookies, customer) {
    $scope.modal = {};
