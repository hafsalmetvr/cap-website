...
var app = angular.module("cap", [ "ngAnimate", "ngCookies", "cap.controllers", "cap.controllers.mentee", "cap.filters", "cap.router", "cap.services", "cap.directives" ]);
...
angular.module("cap.controllers.mentee", []).controller("DashboardCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", "customer", "overlay", function($scope, $element, $http, $timeout, $window, $cookies, customer, overlay) {
    $scope.init = function() {
...
} ]).controller("MentorCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", "overlay", function($scope, $element, $http, $timeout, $window, $cookies, overlay) {
...
} ]).controller("QuestionnairePageCtrl", [ "$scope", "$element", "$http", "$timeout", "$cookies", "customer", "overlay", "$window", function($scope, $element, $http, $timeout, $cookies, customer, overlay, $window) {
...
} ]).controller("QuestionnaireCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {} ]);