...
angular.module("cap.controllers.mentee", []).controller("DashboardCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", "customer", function($scope, $element, $http, $timeout, $window, $cookies, customer) {
    $scope.init = function() {
