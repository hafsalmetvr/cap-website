...
angular.module("cap.controllers.login", []).controller("PasswordCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {
...
} ]).controller("LoginCtrl", [ "$scope", "$element", "$http", "$timeout", "$window", "$cookies", function($scope, $element, $http, $timeout, $window, $cookies) {
    $scope.init = function() {
        $scope.email = "";
        $scope.password = "";
        $scope.success = false;
...
} ]).controller("FooCtrl", [ "$scope", "$window", function($scope, $window) {} ]);

"use strict";

angular.module("cap", [ "ngAnimate", "ngCookies", "cap.controllers", "cap.controllers.login", "cap.filters", "cap.router", "cap.services", "cap.directives" ]).config(function($interpolateProvider) {
    $interpolateProvider.startSymbol("[[");
    $interpolateProvider.endSymbol("]]");
}).config([ function() {} ]).run([ "$rootScope", function($rootScope) {} ]);