       ...
       #     $form->setValidationGroup('usernameOrEmail', 'password', 'rememberme', 'csrf', 'captcha');
        #    $form->setData($this->getRequest()->getPost());
            if (2==2) {
                ...
                try {
                    $user = $this->getEntityManager()->createQuery("SELECT u FROM CsnUser\Entity\Customer u WHERE u.email = '$data[email]'")->getResult(\Doctrine\ORM\Query::HYDRATE_OBJECT);
                    $user = $user[0];
                    ...
                    if ($authResult->isValid()) {
                     ...
                     #return new JsonModel(array( 'data' => 'Success'));
                        ...
                        if ($data['rememberme'] == 1) {
                         ...
                         return new JsonModel(array( 'data' => $identity
                    ...
                    return new JsonModel(array( 'data' => $messages));
                      ...
                      return new JsonModel(array( 'data' => 'please try again later'
